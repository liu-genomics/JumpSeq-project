...
barplot(total[,1]/sum(total[,1]), ylim=c(0,1))

```
This figure shows the ratio of reads within 20 bp window in the center with the center site being ca, cc, cg, ct, in plus strand. Obviously, over 99% reads are generated from cg.   
...
### number of reads versus 5hmC percentage 
...
plot(hmc.ratio, num.reads, type="o", xlab="5hmC percentage", ylab="Number of reads in spike in", main="20170531")
...
num.reads=num.reads.plus+num.reads.minus
hmc.ratio=c(0, 0.01, 0.05, 0.1, 0.25, 0.5, 0.75, 1)
plot(hmc.ratio, num.reads, type="o", xlab="5hmC percentage", ylab="Number of reads in spike in", main="20170605")

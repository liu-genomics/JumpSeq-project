...
legend(1, 1, c("Jump-seq", "Dali's peak"), col=c(1,2), lty=c(1,1))
...
legend(1, 0.5, c("Jump-seq", "strong TAB-seq"), col=c(1,2), lty=c(1,1))
axis.labels <-c("2.4ng combine ", "6ng", "12ng", "24ng", "48ng(90%)")
axis(1, at=seq(1,5), labels=axis.labels)

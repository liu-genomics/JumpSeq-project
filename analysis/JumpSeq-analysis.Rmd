...
par(mfrow=c(1,2))
plot(seq(1,200)-101, minus2.4ng, xlab="Distance", ylab="Num.reads", type="l", main="48ng_11rep_merge.minus")
plot(seq(1,200)[91:111]-101, minus2.4ng[91:111], xlab="Distance", ylab="Num.reads", type="l", main="48ng_11rep_merge")
```
...
par(mfrow=c(1,2))
plot(seq(1,200)-99, minus2.4ng, xlab="Distance", ylab="Num.reads", type="l", main="48ng_11rep_merge.plus")
plot(seq(1,200)[91:111]-99, minus2.4ng[91:111], xlab="Distance", ylab="Num.reads", type="l", main="48ng_11rep_merge")
```
...
barplot(percent, beside=T, col=c("red", "darkblue"), legend=c("Jump-seq peaks", "Random windows"), ylim=c(0,0.009),
...
barplot(percent, beside=T, col=c("red", "darkblue"), legend=c("Jump-seq peaks", "Random windows"), ylim=c(0,0.008),
...
```{r, echo=T}
percent=matrix(nrow=2, ncol=5)
percent[,1]=c(0.0254, 0.0032)
percent[,2]=c(0.0829, 0.0034)

percent[,3]=c(0.0186, 0.0026)
percent[,4]=c(0.0486, 0.0021)

percent[,5]=c(0.0027, 0.0011)
colnames(percent)=c("ctcf", "enhancer", "h3k27ac", "h3k4me3", "polII")
...
par(mfrow=c(1,2))
plot(seq(1,200)-101, minus2.4ng, xlab="Distance", ylab="Num.reads", type="l", main="CHe-lu-2.4ng_mixed_with_other_library.minus")
plot(seq(1,200)[91:111]-101, minus2.4ng[91:111], xlab="Distance", ylab="Num.reads", type="l", main="CHe-lu-2.4ng_mixed_with_other_library.minus")
```
...
par(mfrow=c(1,2))
plot(seq(1,200)-99, minus2.4ng, xlab="Distance", ylab="Num.reads", type="l", main="CHe-lu-2.4ng_mixed_with_other_library.plus")
plot(seq(1,200)[91:111]-99, minus2.4ng[91:111], xlab="Distance", ylab="Num.reads", type="l", main="CHe-lu-2.4ng_mixed_with_other_library.plus")
```
...
Only focus on reads from 96 base to 102 base. 
```{r, echo=T}
num.reads.plus1=c(34536, 103817, 282178,  1398644, 1374788, 2427158, 3002380, 3198060)
num.reads.plus2=c(21389, 84709, 241444, 1184547, 1171380, 2109440, 2578213, 2757798)
hmc.ratio=c(0, 0.01, 0.05, 0.1, 0.25, 0.5, 0.75, 1)
plot(hmc.ratio, num.reads.plus1, type="o", xlab="5hmC percentage", ylab="Number of reads in spike in", main="reads in base >=96 & <=102", col=1, ylim=c(21000, 3200000))
lines(hmc.ratio, num.reads.plus2, col=2, type="o")

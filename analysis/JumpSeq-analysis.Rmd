...
pie(slices,radius=0.7, labels = lbls, cex=0.7, col=rainbow(length(lbls)),
  	main="Jump-seq peak windows (90% reads)", cex.main=0.9, sub="plus strand")
...
lbls <- paste(lbls,"%",sep="") # ad % to labels 
pie(slices,radius=0.7, labels = lbls, cex=0.7, col=rainbow(length(lbls)),
  	main=" Dali's peaks (90% reads)", cex.main=0.9, sub="plus strand")
```
...
lbls <- paste(lbls,"%",sep="") # ad % to labels 
pie(slices,radius=0.7, labels = lbls, cex=0.7, col=rainbow(length(lbls)),
  	main=" strong TAB-seq (90% reads)", cex.main=0.9, sub="plus strand")
```

...
fit
plot(hmc.ratio, num.reads.plus1/num.reads.plus1[1], xlim=c(0,1), ylim=c(0, 110), type="o", ylab="fold change", xaxt="n", main="plus1")
axis(1, at =hmc.ratio, las=0, cex.axis=0.5)
lines(hmc.ratio, fit$coefficients[1]+fit$coefficients[2]*hmc.ratio, col=2, type="o")
...
plot(ave, type="o", xaxt='n', xlab="Window length",ylim=c(0,1), ylab="Correlation", pch=16)
axis.labels <-c("20bp", "1kbp", "5kbp", "10kbp")

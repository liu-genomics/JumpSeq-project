...
```{r, echo=T,  eval =T}
num.win.FDR5per=c(1848560, 2149967, 2635168, 2738080, 3066015, 3458501, 3789453)
...
```{r, echo=T,  eval =T}
num.win.FDR5per=c(1854249, 2148405, 2632652, 2736153, 3082261, 3456391, 3812734)
...
```{r, echo=T}
jump.rate.minus=c(0.1518, 0.1516, 0.1457, 0.1494, 0.1460, 0.1425, 0.1397)
jump.rate.plus=c(0.1511, 0.1512, 0.1454, 0.1491, 0.1458, 0.1424, 0.1391)
dali.rate.minus=c(0.8715, 0.8866, 0.9001, 0.9039, 0.9102, 0.9156, 0.9189)
dali.rate.plus=c(0.8709, 0.8863, 0.8999, 0.9039, 0.9095, 0.9153, 0.9193)
...
```{r, echo=T}
ratio=c(0.1397, 0.9189)
barplot(ratio, beside=F, ylim=c(0,1.4), col=c("red", "darkblue"), legend=c("Jump-Seq", "nano hmC_seal"), xlab="", main="48ng(combine) minus strand", ylab="Overlap rate")
text(0.6, 0.2, ratio[1])
text(2, 1.0, ratio[2])
```

```{r, echo=T}
ratio=c(0.1391, 0.9193)
barplot(ratio, beside=F, ylim=c(0,1.4), col=c("red", "darkblue"), legend=c("Jump-Seq", "nano hmC_seal"), xlab="", main="48ng(combine) plus strand", ylab="Overlap rate")
text(0.6, 0.2, ratio[1])
text(2, 1.0, ratio[2])
```
...
```{r, echo=T}
ratio=c(0.2432, 0.4693)
barplot(ratio, beside=F, ylim=c(0,0.7), col=c("red", "darkblue"), legend=c("Jump-Seq", "strong TAB-seq"), xlab="", main="48ng(combine) minus strand", ylab="Overlap rate")
text(0.6, 0.3, ratio[1])
text(2, 0.5, ratio[2])
```

```{r, echo=T}
ratio=c(0.2429, 0.4709)
barplot(ratio, beside=F, ylim=c(0,0.7), col=c("red", "darkblue"), legend=c("Jump-Seq", "strong TAB-seq"), xlab="", main="48ng(combine) plus strand", ylab="Overlap rate")
text(0.6, 0.3, ratio[1])
text(2, 0.5, ratio[2])
```
```{r, echo=T}
...
plot(1+seq(-100, 100, by=1),minus.48ng[,1], type="l", ylab="coverage", xlab="position", main="20161115_5hmC_Jump_Seq_2hmC_spike_in.minus")
abline(v=0, col=2)

plot(1+seq(-100, 100, by=1),plus.48ng[,1], type="l", ylab="coverage", xlab="position", main="20161115_5hmC_Jump_Seq_2hmC_spike_in.plus")
abline(v=0, col=2)
...
colnames(percent)=paste(rep(c("2.4ng(combine)", "6ng", "12ng", "24ng", "48ng (combine)"), each=2), c("Nano hmC_Seal", "strongTAB"), sep="_")

#barplot(percent, beside=T, col=c("red", "darkblue"), legend=c("Observed", "Expected"), ylim=c(0,0.4),
#xlab="", main="", ylab="overlap rate", cex.names=0.5)
barplot(percent[,c(1,3,5,7,9)], beside=T, col=c("red", "darkblue"), legend=c("Observed", "Expected"), ylim=c(0,0.3),
xlab="", main="", ylab="overlap rate", cex.names=0.5)

barplot(percent[,c(2,4,6,8,10)], beside=T, col=c("red", "darkblue"), legend=c("Observed", "Expected"), ylim=c(0,0.4),
xlab="", main="", ylab="overlap rate", cex.names=0.5)
```
...
#text(2, 0.1, 4.2819)
#text(4, 0.1, 4.7574)
#text(6, 0.12, round(percent[1,5]/percent[2,5],4))
#text(8, 0.12, round(percent[1,7]/percent[2,7],4))
#text(10, 0.12, round(percent[1,9]/percent[2,9],4))

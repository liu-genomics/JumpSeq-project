...
plot(scale_hmc_combine[male.index,1], ylim=c(min.limit,max.limit), type="o", xaxt='n', xlab="", ylab="normalized reads count", col=1, main="", cex.main=0.8, cex.lab=1, lty=1, pch=16)
for (i in 2:num.regions)
  lines(scale_hmc_combine[male.index,i], col=i, type="o", lty=1, pch=16)
legend(1, max.limit, regions, col=seq(1,num.regions), lty=rep(1,num.regions), ncol=2, cex=0.65)
for (i in 1:num.regions)
  lines(scale_hmc_combine[female.index,i], col=i, type="o", lty=3, pch=16)
legend(1, max.limit, regions, col=seq(1,num.regions), lty=rep(1,num.regions), ncol=2, cex=0.65)

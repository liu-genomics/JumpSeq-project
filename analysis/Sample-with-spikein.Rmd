...
hmc_male=rbind(scale.reads[5,], scale.reads[10,], scale.reads[12,], scale.reads[14,], scale.reads[16,], scale.reads[1,], scale.reads[2:4,] )
rownames(hmc_male)=hmc_male[,1]
hmc_male=hmc_male[,-1]
heatcol <- brewer.pal(9, "Greens")
hmc_male2=hmc_male[2:5,]
...
```{r, echo=F, warning=F}
scale.reads=read.csv("D:\\ResearchWork\\StatisticalGenetics\\JumpSeq\\20180228\\scale.reads.csv")
hmc_male=rbind(scale.reads[5,], scale.reads[9,], scale.reads[11,], scale.reads[13,], scale.reads[15,], scale.reads[1,], scale.reads[2:4,] )
rownames(hmc_male)=hmc_male[,1]
hmc_male=hmc_male[,-1]
heatcol <- brewer.pal(9, "Greens")
hmc_male2=hmc_male[2:5,]

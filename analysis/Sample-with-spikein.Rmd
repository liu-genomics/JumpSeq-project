...
```{r, echo=F, eval=F}
samples=c("mc-PN5","mc-1cell", "mc-2cellearly", "mc-MII", "mc-sperm", "mc-sperm-repeat", "mc-ES",  "mc-PN1female", "mc-PN1male", "mc-PN2female", "mc-PN2male", "mc-PN3female", "mc-PN3male", "mc-PN4female", "mc-PN4male")
regions=c("3UTR", "5UTR", "CDS", "TTS", "Intron", "Intergenic","Promoter")
num.regions=length(regions)
...
```{r, echo=F, warning=F}
all.stages=c("Sperm", "PN1","PN2","PN3","PN4","PN5","1cell","2cellearly",  "ES")
scale.reads=read.csv("D:\\ResearchWork\\StatisticalGenetics\\JumpSeq\\20180227_5mC_2\\scale.reads.xiaolong.annotation.csv")
new.scale.reads=read.csv("D:\\ResearchWork\\StatisticalGenetics\\JumpSeq\\20180420\\scale.reads.xiaolong.annotation.csv")

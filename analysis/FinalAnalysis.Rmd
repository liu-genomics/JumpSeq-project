...
dat=read.table("D:\\ResearchWork\\StatisticalGenetics\\JumpSeq\\5hmC\\mm9.genome.500bp.window.bed.CHe-Lu-1_S12_L005_R1_001.plus.21.bp.bed.He-Lu-lu-1-48ng_S1_L006_R1_001.plus.21.bp.win.bed", header=F)
dat.num=as.matrix(dat[,4:5])
dat.num[dat.num=="."]=0
dat.num[is.na(dat.num)]=0
corre=round(cor(as.numeric(dat.num[,1]), as.numeric(dat.num[,2])), digits=2)
...
xlab="", main="", ylab="Proportion of TAB-seq peaks", cex.names=0.5)
```
...
xlab="", main="", ylab="Proportion of Nano-seal peaks", cex.names=0.5)
```

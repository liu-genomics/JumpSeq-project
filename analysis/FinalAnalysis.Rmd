...
text(2.2, 0.01, "2.16(p<2.2e-16)")
text(4.8, 0.017, "4.09(p<2.2e-16)")
text(8.2, 0.01, "2.67(p<2.2e-16)")
text(10.8, 0.007, "2.00(p<2.2e-16)")
...
text(2.2, 0.04, "2.28(p<2.2e-16)")
text(5.2, 0.022, "2.42(p=1.426e-13)")
text(8.2, 0.074, "4.98(p<2.2e-16)")
text(11, 0.06, "1.94(p<2.2e-16)")
text(14, 0.002, "0.50(p=1)")
```

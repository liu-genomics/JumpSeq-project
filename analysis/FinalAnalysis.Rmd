...
scale.reads=read.csv("D:\\ResearchWork\\StatisticalGenetics\\JumpSeq\\20180113\\scale.reads.xiaolong.annotation.use.large.as.baseline.csv")
new.scale.reads=read.csv("D:\\ResearchWork\\StatisticalGenetics\\JumpSeq\\20180420\\scale.reads.xiaolong.annotation.use.large.as.baseline.csv")
...
```{r, echo=F}
############## replicate 2 ####################
second.rep.scale.reads=read.csv("D:\\ResearchWork\\StatisticalGenetics\\JumpSeq\\20180228\\scale.reads.xiaolong.annotation.use.large.as.baseline.csv")
new.scale.reads=read.csv("D:\\ResearchWork\\StatisticalGenetics\\JumpSeq\\20180420\\scale.reads.xiaolong.annotation.use.large.as.baseline.csv")
...
```{r, echo=F}
############# maternal 
scale.reads=read.csv("D:\\ResearchWork\\StatisticalGenetics\\JumpSeq\\20180420\\scale.reads.xiaolong.annotation.use.large.as.baseline.csv")
...
```{r, echo=F}
############ paternal 
scale.reads=read.csv("D:\\ResearchWork\\StatisticalGenetics\\JumpSeq\\20180227\\scale.reads.xiaolong.annotation.use.large.as.baseline.csv")
new.scale.reads=read.csv("D:\\ResearchWork\\StatisticalGenetics\\JumpSeq\\20180420\\scale.reads.xiaolong.annotation.use.large.as.baseline.csv")
